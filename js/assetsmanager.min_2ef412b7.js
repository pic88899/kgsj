...
!function(e) {
    var r = function() {
        ...
        return r.prototype.pushResItem = function(e) {
            if (this.promiseHash[e.root + e.name])
                return this.promiseHash[e.root + e.name];
        ...
        r.prototype.findPriorityInDic = function(e) {
            for (var r in this.itemListPriorityDic)
                if (this.itemListPriorityDic[r].indexOf(e) > -1)
                    return parseInt(r)
        }
        ,
        ...
        r.prototype.loadSingleResource = function() {
            ...
            return t ? (this.itemLoadDic[t.root + t.name] = 1,
            this.loadingCount++,
            this.loadResource(t).then(function(o) {
                if (r.loadingCount--,
                delete r.itemLoadDic[t.root + t.name],
                e.host.save(t, o),
                r.promiseHash[t.root + t.name]) {
                ...
                if (delete r.retryTimesDic[t.name],
                r.promiseHash[t.root + t.name]) {
                ...
                if (a) {
                    ...
                    for (var s = 0, u = a; s < u.length; s++) {
                        var c = u[s];
                        r.loadItemErrorDic[c] || (r.loadItemErrorDic[c] = []),
                        -1 == r.loadItemErrorDic[c].indexOf(t) && r.loadItemErrorDic[c].push(t),
                        r.groupErrorDic[c] = !0,
                        r.setGroupProgress(c, t) ? r.loadGroupEnd(c, o) : r.errorDic[c] = o
                    }
                }
                r.loadNextResource()
            }),
        ...
        r.prototype.getOneResourceInfoInGroup = function() {
            ...
            if (t)
                return 0 == t.length ? (delete this.itemListPriorityDic[e],
                this.getOneResourceInfoInGroup()) : t.shift()
        }
        ,
        ...
        r.prototype.deleteDispatcher = function(e) {
            ...
            return delete this.dispatcherDic[e],
            r
        }
        ,
        ...
        r.prototype.unloadResource = function(r) {
            ...
            return o ? (o.onRemoveStart(e.host, r),
            e.host.remove(r),
...
!function(e) {
    function r(r) {
        ...
        t = e.config.config.fileSystem.getFile(r)),
        t
    }
    function t(e, r) {
        var t;
    ...
    var n = function() {
        ...
        t.prototype.getGroupByName = function(r) {
            ...
            for (var n = 0, i = t; n < i.length; n++) {
                var a = i[n]
                  , s = void 0;
                if (s = e.config.getResourceWithSubkey(a),
                null != s) {
                    var u = s.r
                      , c = s.key;
                    if (null == u)
                        throw new e.ResourceManagerError(2005,c);
        ...
        t.prototype.removeResourceData = function(r) {
            e.hasRes(r.name) && (e.config.config.fileSystem.removeFile(r.url),
...
!function(e) {
    ...
    function R(e, r, t, o, n) {
        ...
        void 0 === n && (n = 0),
        P || (P = new D),
        P.addEventListener(e, r, t, o, n)
    }
    function E(e, r, t, o) {
        void 0 === o && (o = !1),
        P.removeEventListener(e, r, t, o)
    }
    function y(e) {
        P.addResourceData(e)
    }
    ...
    e.getResByUrl = d,
    e.destroyRes = v,
    e.setMaxLoadingThread = h,
    e.setMaxRetryTimes = m,
    e.addEventListener = R,
    e.removeEventListener = E,
    e.$addResourceData = y,
    e.getVersionController = _,
    e.registerVersionController = S,
    e.getVirtualUrl = L;
    var D = function(r) {
        function t() {
            var t = r.call(this) || this;
            return t.isVcsInit = !1,
            t.normalLoadConfig = function() {
            ...
            ,
            e.VersionController && (t.vcs = new e.VersionController),
            t
        }
        return __extends(t, r),
        t.prototype.registerVersionController = function(e) {
            this.vcs = e,
            this.isVcsInit = !1
        }
        ,
        ...
        t.prototype.loadGroup = function(r, t, o) {
            ...
            var i = {
                onProgress: function(t, i, a) {
                    o && o.onProgress && o.onProgress(t, i, a),
                    e.ResourceEvent.dispatchResourceEvent(n, e.ResourceEvent.GROUP_PROGRESS, r, a, t, i)
                }
            };
            return this._loadGroup(r, t, i).then(function(t) {
                ...
                return e.isCompatible && console.warn(t.error.message),
                e.ResourceEvent.dispatchResourceEvent(n, e.ResourceEvent.GROUP_LOAD_ERROR, r),
        ...
        t.prototype.getResAsync = function(r, t, o) {
            ...
            if (null == a)
                return t && t.call(o, null, i),
                Promise.reject(new e.ResourceManagerError(2006,r));
            var s = this.getRes(r);
            if (s)
                return t && egret.callLater(function() {
                    t.call(o, s, i)
                }, this),
                Promise.resolve(s);
            var u = a.r
            ...
            return e.queue.pushResItem(u).then(function(n) {
                ...
                return a && a.getData && c && (n = a.getData(e.host, u, r, c)),
                t && t.call(o, n, i),
                n
            }, function(r) {
                return e.host.remove(u),
                e.ResourceEvent.dispatchResourceEvent(n, e.ResourceEvent.ITEM_LOAD_ERROR, "", u),
                t ? (t.call(o, null, i),
                Promise.reject(null)) : Promise.reject(r)
            })
        }
        ,
        ...
        t.prototype.destroyRes = function(r, t) {
            ...
            return s ? e.queue.unloadResource(s) : (console.warn("在内存" + r + "资源不存在"),
            !1)
        }
        ,
        ...
        __decorate([e.checkNull], t.prototype, "getResAsync", null),
        __decorate([e.checkNull], t.prototype, "getResByUrl", null),
        t
    }(egret.EventDispatcher);
    e.Resource = D,
    __reflect(D.prototype, "RES.Resource");
    var P
}(RES || (RES = {}));
var RES;
!function(e) {
...
!function(e) {
    function r() {
        e.config.config.fileSystem.profile(),
        console.log(t);
        var r = 0;
        for (var o in t) {
            var n = t[o];
    ...
    !function(r) {
        ...
        r.ImageProcessor = {
            onLoadStart: function(r, t) {
                ...
                return o.load(e.getVirtualUrl(t.root + t.url)),
                n(o, t).then(function(e) {
        ...
        r.KTXTextureProcessor = {
            onLoadStart: function(e, r) {
                return e.load(r, "bin").then(function(t) {
                    if (!t)
                        return console.error("ktx:" + r.root + r.url + " is null"),
                        null;
                    var o = new egret.KTXContainer(t,1);
                    if (o.isInvalid)
                        return console.error("ktx:" + r.root + r.url + " is invalid"),
                        null;
                    var n = new egret.BitmapData(t);
                    n.debugCompressedTextureURL = r.root + r.url,
                    n.format = "ktx",
                    o.uploadLevels(n, !1);
        ...
        r.makeEtc1SeperatedAlphaResourceInfo = a,
        r.ETC1KTXProcessor = {
            onLoadStart: function(e, r) {
                return e.load(r, "ktx").then(function(t) {
                    ...
                    if (r.etc1_alpha_url) {
                        ...
                        return e.load(o, "ktx").then(function(r) {
                            return t && t.$bitmapData && r.$bitmapData ? (t.$bitmapData.etcAlphaMask = r.$bitmapData,
                            e.save(o, r)) : e.remove(o),
                            t
                        }, function(r) {
                            throw e.remove(o),
                            r
        ...
        r.BinaryProcessor = {
            onLoadStart: function(r, t) {
                ...
                return o.responseType = egret.HttpResponseType.ARRAY_BUFFER,
                o.open(e.getVirtualUrl(t.root + t.url), "get"),
                o.send(),
                n(o, t)
            },
            onRemoveStart: function(e, r) {}
        ...
        r.MovieClipProcessor = {
            onLoadStart: function(r, t) {
                ...
                return r.load(t, "json").then(function(i) {
                    ...
                    if (n = r.resourceConfig.getResource(s),
                    !n)
...
!function(e) {
    ...
    e.NativeVersionController = r,
    __reflect(r.prototype, "RES.NativeVersionController", ["RES.IVersionController"]),
