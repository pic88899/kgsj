...
!function(t) {
    ...
    var r = function(e) {
        ...
        r.prototype.setPosition = function(t, e) {
            ...
            0 != e && this._actions.length > 0 && (this._useTicks ? this._runActions(r, r) : 1 == e && o > r ? (o != this.duration && this._runActions(o, this.duration),
            this._runActions(0, r, !0)) : this._runActions(o, r)),
    ...
    var e = function(e) {
        ...
        r.prototype.setScrollPosition = function(t, e, r) {
            ...
            (!r || 0 != t || 0 != e) && (r || this._ScrV_Props_._scrollTop != t || this._ScrV_Props_._scrollLeft != e)) {
                ...
                if (r) {
                    ...
                    c || ((0 >= a || a >= s) && (a = Math.max(0, Math.min(a, s))),
        ...
        r.prototype._moveAfterTouchEnd = function() {
            if (0 != this._ScrV_Props_._velocitys.length) {
                ...
                var s = t.x / e * this.scrollSpeed
                  ...
                  , p = h > .02 ? this.getAnimationDatas(s, this._ScrV_Props_._scrollLeft, l) : {
        ...
        r.prototype.getAnimationDatas = function(t, e, r) {
            ...
            if (0 > h || h > r)
                ...
                n = 500 * -Math.log(a / i);
            var c = {
                position: Math.min(r + 50, Math.max(h, -50)),
                duration: n
            };
            return c
        }
...
!function(t) {
    ...
    var r = function(r) {
        ...
        i.prototype.loadSound = function(e) {
            ...
            i.addEventListener(t.IOErrorEvent.IO_ERROR, this.onSoundLoaderError, this),
            i.addEventListener(t.ProgressEvent.PROGRESS, this.onSoundLoaderPostProgress, this),
            i.load(r)
        }
        ,
        ...
        i.prototype.removeSoundLoaderListeners = function() {
            this.sound.removeEventListener(t.Event.COMPLETE, this.onSoundoadComplete, this),
            this.sound.removeEventListener(t.IOErrorEvent.IO_ERROR, this.onSoundLoaderError, this),
            this.sound.removeEventListener(t.ProgressEvent.PROGRESS, this.onSoundLoaderPostProgress, this)
        }
        ,
        i.prototype.loadTexture = function(e) {
            ...
            r.addEventListener(t.IOErrorEvent.IO_ERROR, this.onImageLoaderError, this),
            r.addEventListener(t.ProgressEvent.PROGRESS, this.onImageLoaderPostProgress, this),
        ...
        i.prototype.onImageLoadComplete = function(e) {
            ...
            o.source.setAttribute && o.source.setAttribute("bitmapSrc", this.virtualUrl),
            i._setBitmapData(o),
            this.data = i,
            window.setTimeout(function() {
                r.dispatchEventWith(t.Event.COMPLETE)
        ...
        i.prototype.removeImageLoaderListeners = function() {
            this.imageLoader.removeEventListener(t.Event.COMPLETE, this.onImageLoadComplete, this),
            this.imageLoader.removeEventListener(t.IOErrorEvent.IO_ERROR, this.onImageLoaderError, this),
            this.imageLoader.removeEventListener(t.ProgressEvent.PROGRESS, this.onImageLoaderPostProgress, this)
        }
        ,
        ...
        r.prototype.$updateRenderNode = function() {
            ...
            if (e) {
                var r = Math.round(this.offsetPoint.x)
                  ...
                  , l = e.$sourceWidth
                  , u = e.$sourceHeight;
                t.sys.BitmapNode.$updateTextureData(this.$renderNode, e.$bitmapData, e.$bitmapX, e.$bitmapY, o, n, r, i, s, a, h, c, l, u, t.BitmapFillMode.SCALE, this.$smoothing)
            }
        }
        ,
...
!function(t) {
    function e(e, r, h) {
        for (var c = [], l = 3; l < arguments.length; l++)
            c[l - 3] = arguments[l];
        var u = {
            listener: e,
            thisObject: r,
